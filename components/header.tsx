...
import { GraduationCapIcon, List, ShootingStarIcon, UsersIcon, X } from '@phosphor-icons/react'
...
const menuItems = [
    ...
    { icon: UsersIcon, name: 'About', href: '#link' },
]
                    ...
                    <div className="relative flex flex-wrap items-center justify-between gap-6 py-3 lg:gap-0">
                        <div className="flex w-full justify-between gap-6 lg:w-auto">
                            ...
                            <button
                                ...
                                <List className="in-data-[state=active]:rotate-180 in-data-[state=active]:scale-0 in-data-[state=active]:opacity-0 m-auto size-6 duration-200" />
